...
__all__ = [
    'SpeechCategoryAudioOut', 'DISPID_SpeechAudio',
    'DISPID_SpeechPhraseElements', 'DISPID_SRRecognizer',
    'SVSFPersistXML', 'DISPID_SLWWord',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SVESentenceBoundary', 'SECFDefault', 'STSF_FlagCreate',
    'DISPID_SPEsItem', 'SPAR_Medium', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SPCPhoneToId', 'DISPID_SpeechBaseStream',
    'ISpPhoneConverter', 'eLEXTYPE_PRIVATE15', 'SPRECOCONTEXTSTATUS',
    'SDTReplacement', 'DISPID_SpeechObjectToken',
    'DISPID_SGRSAddRuleTransition', 'SpInProcRecoContext',
    'SAFT12kHz8BitStereo', 'SP_VISEME_11', 'SAFT24kHz16BitMono',
    '_RemotableHandle', 'SPWT_LEXICAL', 'eLEXTYPE_PRIVATE5',
    'DISPID_SWFEExtraData', 'STSF_LocalAppData', 'SPRST_ACTIVE',
    'DISPID_SpeechPhraseElement', 'DISPID_SLWLangId', 'SDTProperty',
    'DISPID_SpeechAudioStatus', 'SPSVerb', 'SAFT44kHz8BitStereo',
    'SPADAPTATIONRELEVANCE', 'SPAO_NONE', 'SpeechAudioVolume',
    'DISPID_SCSBaseStream', 'SpShortcut', 'SPEI_START_SR_STREAM',
    'eLEXTYPE_MORPHOLOGY', 'SVP_17', 'SP_VISEME_5',
    'ISpeechRecoResult2', 'SpInprocRecognizer', 'SGRSTTDictation',
    'SAFT48kHz8BitMono', 'DISPID_SRCEInterference', 'SREAudioLevel',
    'SRTReSent', 'SRAImport', 'DISPID_SABufferInfo',
    'SpeechAudioFormatType', 'SAFT24kHz16BitStereo', 'DISPIDSPTSI',
    'SPRST_ACTIVE_ALWAYS', 'SRARoot', 'DISPID_SPPId',
    'SPRECORESULTTIMES', 'SPAUDIOOPTIONS',
    'DISPID_SPRNumberOfElements', 'ISpeechPhraseRules', 'DISPIDSPRG',
    'Speech_Default_Weight', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SRGRecoContext', 'ISpResourceManager',
    'DISPID_SpeechRecoResultTimes', 'SVSFParseAutodetect',
    'SpeechDataKeyLocation', 'SpeechTokenIdUserLexicon',
    'DISPID_SGRsAdd', 'SVP_18', 'SPRECOSTATE', 'SP_VISEME_12',
    'SpeechStreamSeekPositionType', 'DISPID_SRGSetTextSelection',
    'ISpPhrase', 'SPVOICESTATUS', 'SpeechVoiceSpeakFlags',
    'SpTextSelectionInformation', 'SPSInterjection', 'SDTLexicalForm',
    'DISPID_SBSRead', 'SSSPTRelativeToEnd', 'SITooQuiet',
    'DISPID_SpeechMemoryStream', 'SVP_21', 'DISPID_SOTDataKey',
    'eLEXTYPE_PRIVATE12', 'SPSHORTCUTTYPE', 'DISPID_SLGenerationId',
    'SAFTCCITT_ALaw_8kHzMono', 'SPCATEGORYTYPE', 'DISPID_SRGReset',
    'DISPID_SLWsItem', 'SVEPrivate', 'DISPID_SVVoice',
    'SPWF_SRENGINE', 'ISpProperties', 'ISpObjectToken', 'SVSFDefault',
    'DISPID_SAFType', 'SAFTCCITT_ALaw_11kHzStereo', 'SREAdaptation',
    'ISpVoice', 'SDTRule', 'DISPID_SRCPause', 'DISPID_SRCResume',
    'DISPID_SGRInitialState', 'DISPID_SRCEventInterests',
    'SVSFIsNotXML', 'SpeechMicTraining', 'SPEI_PHONEME',
    'Speech_Max_Word_Length', 'SpeechVoiceSkipTypeSentence', 'SLTApp',
    'SGDSActiveWithAutoPause', 'SDA_Two_Trailing_Spaces',
    'SAFT11kHz16BitMono', 'DISPID_SRRGetXMLErrorInfo',
    'eLEXTYPE_PRIVATE1', 'UINT_PTR', 'SREHypothesis', 'SVP_12',
    'DISPID_SGRsCommitAndSave', 'DISPID_SOTsItem',
    'DISPID_SABufferNotifySize', 'SRAExport', 'SPDATAKEYLOCATION',
    'SpeechRegistryUserRoot', 'SVSFParseMask',
    'SPEI_RECO_OTHER_CONTEXT', 'SPBO_TIME_UNITS',
    'DISPIDSPTSI_ActiveLength', 'SPRS_INACTIVE', 'SPEI_SR_BOOKMARK',
    'SVEWordBoundary', 'SVF_Stressed', 'SPPS_NotOverriden', 'SPRULE',
    'ISpeechRecognizerStatus', 'SDA_One_Trailing_Space',
    'DISPID_SRCERecognitionForOtherContext',
    'SAFTCCITT_uLaw_8kHzMono', 'SPINTERFERENCE_TOOLOUD',
    'SPPROPERTYINFO', 'SRCS_Enabled', 'DISPID_SPIProperties',
    'DISPID_SABIBufferSize', 'SVP_5', 'SRSActive',
    'DISPID_SPPChildren', 'SPSERIALIZEDRESULT',
    'DISPID_SpeechObjectTokenCategory', 'SPEI_RESERVED6',
    'SAFTGSM610_44kHzMono', 'STCRemoteServer',
    'DISPID_SOTMatchesAttributes', 'DISPID_SRCERequestUI',
    'eLEXTYPE_APP', 'SPRST_NUM_STATES', 'eLEXTYPE_PRIVATE11',
    'ISpRecognizer', 'SpeechTokenShellFolder', 'SpeechAllElements',
    'SPPS_LMA', 'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SOTRemove',
    'SASClosed', 'SRERecoOtherContext', 'SVSFParseSapi',
    'SSFMOpenForRead', 'eLEXTYPE_PRIVATE14', 'SPPS_RESERVED3',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SpeechLexiconProns',
    'eWORDTYPE_ADDED', 'eLEXTYPE_RESERVED9', 'SVEStartInputStream',
    'ISpeechGrammarRule', 'DISPID_SPPEngineConfidence',
    'SPEI_REQUEST_UI', 'SPEI_TTS_PRIVATE', 'ISpeechLexiconWord',
    'ISpeechRecognizer', 'SVESentenceBoundary', 'SPRS_ACTIVE',
    'SPPHRASERULE', 'DISPID_SVGetProfiles', 'SPBINARYGRAMMAR',
    'SDKLLocalMachine', 'SAFT12kHz16BitMono',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'ISpeechFileStream',
    'DISPID_SPRuleFirstElement', 'eLEXTYPE_PRIVATE10',
    'DISPID_SpeechLexicon', 'ISpeechObjectToken',
    'SAFTADPCM_8kHzMono', 'SAFTNonStandardFormat',
    'DISPID_SPISaveToMemory', 'DISPID_SOTRemoveStorageFileName',
    'ISpeechGrammarRuleState', 'DISPID_SPPsItem', 'SITooSlow',
    'SpeechLoadOption', 'DISPID_SGRSTransitions', 'DISPID_SRStatus',
    'SPLOADOPTIONS', 'DISPID_SRRDiscardResultInfo', 'SVPAlert',
    'DISPID_SGRsItem', 'SPEI_HYPOTHESIS', 'SLODynamic',
    'DISPID_SRGDictationUnload', 'DISPID_SVEAudioLevel',
    'DISPID_SVSCurrentStreamNumber', 'eLEXTYPE_VENDORLEXICON',
    'SP_VISEME_18', 'DISPID_SLPSymbolic', 'SRSEIsSpeaking',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SRCERecognition',
    'SpeechStreamFileMode', 'ISpeechLexiconWords', 'SPBO_NONE',
    'SpNullPhoneConverter', 'ISpeechVoiceStatus',
    'SpeechGrammarTagWildcard', 'DISPID_SRCESoundStart',
    'IInternetSecurityManager', 'SPEI_END_SR_STREAM',
    'SAFT22kHz16BitStereo', 'DISPID_SWFEChannels', 'STSF_AppData',
    'SPWAVEFORMATTYPE', 'DISPID_SPACommit',
    'DISPIDSPTSI_SelectionOffset', 'SRADefaultToActive',
    'DISPID_SRSCurrentStreamNumber', 'SWPUnknownWordPronounceable',
    'SpMMAudioOut', 'DISPID_SLWs_NewEnum',
    'DISPID_SRGCmdSetRuleIdState', 'SPRST_INACTIVE', 'ISpeechAudio',
    'SPGRAMMARSTATE', 'DISPID_SRRGetXMLResult', 'DISPID_SGRSTText',
    'SREPropertyNumChange', 'SSTTWildcard',
    'DISPID_SWFESamplesPerSec', 'SpeechVoicePriority',
    'ISpeechCustomStream', 'SPEI_START_INPUT_STREAM',
    'DISPID_SMSADeviceId', 'ISpeechObjectTokenCategory',
    'DISPID_SpeechFileStream', 'SREStreamStart',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SADefaultFormat',
    'SRSActiveAlways', 'SVP_9', 'SPFM_OPEN_READONLY',
    'SpeechPropertyAdaptationOn', 'eLEXTYPE_PRIVATE6', 'SASPause',
    'SPEI_MIN_SR', 'SPSFunction', 'ISpeechPhraseElements',
    'SPCT_SLEEP', 'WAVEFORMATEX', 'eLEXTYPE_USER',
    'DISPID_SVAlertBoundary', 'DISPID_SPRFirstElement',
    'SAFTGSM610_22kHzMono', 'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SVSpeak', 'SpeechInterference', 'DISPID_SRState',
    'DISPID_SRGIsPronounceable', 'SECHighConfidence',
    'DISPID_SDKOpenKey', 'SGDisplay',
    'DISPID_SPAStartElementInResult', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SGRSTPropertyName', 'DISPID_SVSLastBookmark',
    'DISPID_SGRSTType', 'DISPID_SOTCreateInstance', 'DISPID_SVPause',
    'SPWORDPRONOUNCEABLE', 'DISPID_SpeechPhoneConverter',
    'SGRSTTRule', 'DISPID_SMSSetData', 'SAFTCCITT_ALaw_11kHzMono',
    'ISpPhoneticAlphabetConverter', 'SECNormalConfidence',
    'DISPID_SPRules_NewEnum', 'DISPID_SVStatus',
    'ISpeechObjectTokens', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SDKEnumKeys', 'DISPID_SOTCGetDataKey', 'SFTSREngine',
    'ISpDataKey', 'DISPID_SPEActualConfidence', 'ISpStream',
    'SECLowConfidence', 'DISPID_SMSALineId', 'DISPID_SGRSTsItem',
    'SAFT44kHz16BitMono', 'SPAUDIOSTATUS', 'SREPrivate',
    'DISPID_SPAs_NewEnum', 'SREPropertyStringChange',
    'SPPHRASEPROPERTY', 'DISPID_SRSClsidEngine',
    'DISPID_SpeechDataKey', 'DISPID_SPPNumberOfElements',
    'SPAUDIOBUFFERINFO', 'SAFT11kHz8BitStereo', 'SAFT32kHz16BitMono',
    'SPGS_DISABLED', 'DISPID_SDKGetStringValue', 'SVEVoiceChange',
    ...
    'eLEXTYPE_PRIVATE17', 'ISpNotifyTranslator', 'SVP_1',
    'DISPID_SOTGetDescription', 'DISPID_SLPPhoneIds',
    'DISPID_SpeechPhraseRule', 'DISPID_SOTCategory',
    'DISPID_SpeechPhraseInfo', 'DISPID_SPIRule',
    'DISPID_SRGDictationSetState', 'DISPID_SRCEAdaptation',
    'SSSPTRelativeToStart', 'SPPS_Modifier', 'SGRSTTEpsilon',
    'SPWORD', 'SVEAllEvents', 'SpCustomStream', 'SECFIgnoreCase',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SPIGetText',
    'DISPID_SASFreeBufferSpace', 'IEnumSpObjectTokens',
    'DISPID_SPILanguageId', 'SpeechTokenContext',
    'DISPID_SpeechRecoResult', 'DISPID_SLWPronunciations', 'SVP_20',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SLAddPronunciationByPhoneIds',
    'SpeechCategoryAppLexicons', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SGRSAddWordTransition', 'DISPID_SVDisplayUI',
    'DISPID_SRGId', 'SAFTADPCM_44kHzMono', 'SAFT44kHz16BitStereo',
    'DISPID_SRGetPropertyString', 'SDTPronunciation',
    'ISpeechRecoResult', 'SPEI_PHRASE_START',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SVIsUISupported', 'SPEI_MIN_TTS',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SRGSetWordSequenceData',
    'SpVoice', 'eLEXTYPE_RESERVED10', 'SPBOOKMARKOPTIONS',
    'DISPID_SPERetainedStreamOffset', 'SPRULESTATE', 'ISpShortcut',
    'Speech_Max_Pron_Length', 'SpeechBookmarkOptions',
    'ISpeechPhraseProperty', 'SPPHRASE', 'SRSInactive',
    'ISpeechVoice', 'SpeechCategoryRecoProfiles',
    'SpeechWordPronounceable', 'SAFT24kHz8BitMono',
    'DISPID_SMSGetData', 'SPAR_High', 'SWTDeleted',
    'SAFTCCITT_ALaw_44kHzStereo', 'IInternetSecurityMgrSite',
    'DISPID_SVSPhonemeId', 'SAFTExtendedAudioFormat',
    'SSSPTRelativeToCurrentPosition', 'SVP_7', 'DISPID_SPEs_NewEnum',
    'SASRun', 'SP_VISEME_9', 'SPAS_PAUSE',
    'SpeechGrammarRuleStateTransitionType', 'SpeechTokenKeyUI',
    'SAFT32kHz8BitStereo', 'DISPID_SpeechGrammarRules',
    'SGDSActiveUserDelimited', 'SPBO_AHEAD',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SDKDeleteKey',
    'DISPID_SRCCmdMaxAlternates', 'SPDKL_CurrentConfig',
    'DISPID_SVEventInterests', 'DISPID_SRCVoice',
    'SpNotifyTranslator', 'DISPID_SBSSeek', 'ISpeechBaseStream',
    'SP_VISEME_15', 'SPCS_DISABLED', 'SPCONTEXTSTATE',
    'DISPID_SOTIsUISupported', 'SpeechVisemeFeature', 'SRTAutopause',
    'DISPID_SPIAudioStreamPosition', 'ISpeechDataKey',
    'DISPID_SPPs_NewEnum', 'SPEI_SR_PRIVATE', 'SVSFParseSsml',
    'ISpeechRecoResultTimes', 'SRAInterpreter',
    'DISPID_SRGCmdLoadFromObject', 'SREInterference',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SPEDisplayAttributes',
    'SP_VISEME_17', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SVSRunningState', 'SAFTADPCM_11kHzMono',
    'DISPID_SPPFirstElement', 'ISpObjectTokenCategory', 'SVP_4',
    'SVP_19', 'SAFTCCITT_ALaw_22kHzMono',
    'SpeechPropertyResourceUsage', 'SAFT22kHz16BitMono',
    'DISPID_SPPConfidence', 'SPPS_Noncontent',
    'SpeechRetainedAudioOptions', 'SAFT16kHz8BitMono',
    'DISPID_SGRSTNextState', 'SPAO_RETAIN_AUDIO',
    'DISPID_SLPs_NewEnum', 'DISPID_SVSyncronousSpeakTimeout',
    'SPAR_Unknown', 'DISPID_SRCState', 'SSFMCreateForWrite',
    'DISPID_SRCEBookmark', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SPWORDPRONUNCIATION', 'SPWT_DISPLAY', 'ISpeechPhoneConverter',
    'SVP_11', 'SpeechFormatType', 'DISPID_SPPValue',
    'SPPHRASEELEMENT', 'SAFT32kHz16BitStereo',
    'DISPID_SRCRequestedUIType', 'SAFTNoAssignedFormat',
    'DISPID_SRGCmdSetRuleState', 'DISPIDSPTSI_SelectionLength',
    'SPSUnknown', 'ISpRecoContext2', 'SAFTCCITT_uLaw_44kHzMono',
    'SpeechPropertyHighConfidenceThreshold', 'eLEXTYPE_PRIVATE18',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPEI_RESERVED2',
    'DISPID_SVSInputSentenceLength', 'DISPID_SpeechLexiconWord',
    'SPAUDIOSTATE', 'SAFT11kHz16BitStereo', 'DISPID_SRRTimes',
    'SGDSInactive', 'SPWORDLIST', 'SpeechTokenKeyAttributes',
    'DISPID_SRRTTickCount', 'DISPID_SASState', 'DISPID_SpeechVoice',
    'DISPID_SPARecoResult', 'SpeechDictationTopicSpelling',
    'SGLexical', 'SPSNoun', 'SPSModifier', 'DISPID_SRRAlternates',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SPPBRestorePhraseFromMemory',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SPSNotOverriden',
    'DISPID_SRRSaveToMemory',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'eLEXTYPE_RESERVED4',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SAFT48kHz16BitStereo',
    'ISpRecognizer2', 'DISPID_SGRSRule', 'SPCT_SUB_COMMAND',
    'ISpStreamFormatConverter', 'SpeechRecognitionType',
    'SVSFUnusedFlags', 'SpResourceManager', 'SVEPhoneme',
    'DISPID_SpeechVoiceEvent', 'SWPKnownWordPronounceable',
    'SPEI_WORD_BOUNDARY', 'SPDKL_DefaultLocation',
    'DISPID_SpeechPhraseProperty', 'SDKLCurrentConfig',
    'SAFTADPCM_22kHzMono', 'DISPID_SPRuleName', 'SP_VISEME_1',
    'SP_VISEME_14', 'SREStateChange',
    'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'IEnumString',
    'SPSMF_UPS', 'DISPID_SPRuleConfidence',
    'DISPID_SPIEnginePrivateData', 'SRTExtendableParse', 'SDTAudio',
    'DISPID_SVSInputWordLength', 'SPEI_TTS_BOOKMARK',
    'SAFTADPCM_8kHzStereo', 'SpWaveFormatEx', 'SAFTGSM610_8kHzMono',
    'SPINTERFERENCE_NONE', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SpeechPhraseRules', 'DISPID_SVEPhoneme',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SAFT8kHz8BitMono',
    'Speech_StreamPos_RealTime', 'DISPID_SGRSAddSpecialTransition',
    'ISpeechWaveFormatEx', 'SLTUser', 'ISpStreamFormat',
    'DISPID_SPRs_NewEnum', 'IStream', 'DISPID_SRIsShared',
    'SPPS_Interjection', 'DISPID_SPPParent', 'DISPID_SLPPartOfSpeech',
    'SP_VISEME_10', 'DISPID_SDKGetlongValue', 'ISpNotifySink',
    'eLEXTYPE_PRIVATE7', 'DISPID_SGRAddState', 'SAFT48kHz8BitStereo',
    'DISPID_SLGetWords', 'SRTStandard', 'DISPID_SVGetAudioOutputs',
    'DISPID_SRRTStreamTime', 'ISpeechLexiconPronunciations',
    'SPEI_RESERVED5', 'SP_VISEME_3', 'SVSFlagsAsync',
    'DISPID_SOTGetAttribute', 'SAFT16kHz16BitStereo',
    'SPPS_RESERVED1', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SRCEPropertyNumberChange',
    'DISPID_SpeechPhraseProperties', 'SPEI_UNDEFINED',
    'SPEI_INTERFERENCE', 'SpeechEngineProperties',
    'SpeechAddRemoveWord', 'SLOStatic', 'SpObjectToken',
    'DISPID_SPRsItem', 'DISPID_SPRsCount', 'SAFT16kHz16BitMono',
    'DISPID_SFSOpen', 'SAFTADPCM_22kHzStereo', 'ISpMMSysAudio',
    'SPEI_PROPERTY_NUM_CHANGE', 'ISpeechPhraseReplacements',
    'DISPID_SRAudioInput', 'ISpGrammarBuilder', 'SpeechVoiceEvents',
    'DISPID_SRGetRecognizers', 'SPFM_CREATE', 'DISPID_SASetState',
    'ISpNotifySource', 'DISPID_SGRSTsCount', 'SPINTERFERENCE_NOISE',
    'DISPID_SPIAudioSizeBytes', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SRTEmulated', 'SPSEMANTICFORMAT', 'DISPID_SRGCommit',
    'SPEVENTSOURCEINFO', 'SpeechRecognizerState', 'SITooLoud',
    'DISPID_SRSNumberOfActiveRules', 'SPPS_SuppressWord',
    'DISPID_SRGetPropertyNumber', 'DISPID_SRCEEndStream',
    'DISPID_SRDisplayUI', 'SDTAll', 'SPVISEMES',
    'DISPID_SOTGetStorageFileName', 'DISPID_SPIGrammarId',
    'SPEI_FALSE_RECOGNITION', 'SVSFNLPMask', '_ISpeechVoiceEvents',
    'SAFTADPCM_44kHzStereo', 'DISPID_SBSWrite', 'SPCT_COMMAND',
    'SpeechWordType', 'DISPID_SVSVisemeId', 'SDKLCurrentUser',
    'SPEI_SR_AUDIO_LEVEL', 'DISPIDSPTSI_ActiveOffset', 'SVEViseme',
    'DISPID_SRProfile', 'DISPID_SLAddPronunciation',
    'DISPID_SPRDisplayAttributes', 'DISPID_SRGCmdLoadFromResource',
    'SpeechRecoContextState', 'SRERecognition', 'SREBookmark',
    'SRESoundStart', 'ISpPhraseAlt', 'eLEXTYPE_USER_SHORTCUT',
    'eLEXTYPE_PRIVATE13', 'DISPID_SPEsCount', 'ISpeechRecoContext',
    'SpSharedRecognizer', 'SDA_No_Trailing_Space',
    'DISPID_SpeechRecoContext', 'DISPID_SRRAudio', 'DISPID_SLPsCount',
    'DISPID_SOTsCount', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SPAsCount', 'DISPID_SVSLastBookmarkId',
    '_ISpeechRecoContextEvents', 'SPCT_SUB_DICTATION', 'SPLO_DYNAMIC',
    'DISPID_SVSInputSentencePosition', 'DISPID_SVVolume', 'SBOPause',
    'SVSFIsXML', 'SINoSignal', 'DISPID_SPEDisplayText',
    'DISPID_SREmulateRecognition', 'SPWT_PRONUNCIATION',
    'ISpeechMMSysAudio', 'eLEXTYPE_PRIVATE4', 'ISpXMLRecoResult',
    'STCInprocHandler', 'tagSTATSTG', 'DISPID_SWFEBlockAlign',
    'DISPID_SLWsCount', 'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SRCCreateGrammar', 'DISPID_SPCIdToPhone',
    'SpeechDiscardType', 'SRSEDone', 'SRAORetainAudio',
    'DISPID_SpeechCustomStream', 'SpeechRecoProfileProperties',
    'SpeechAudioFormatGUIDText', 'ISpeechPhraseInfo',
    'SPEI_ADAPTATION', 'ISpeechAudioFormat', 'SRESoundEnd',
    'SPPS_Noun', 'DISPID_SRAudioInputStream',
    'DISPID_SPEAudioSizeBytes', 'SpeechTokenValueCLSID',
    'SRTSMLTimeout', 'DISPID_SPERequiredConfidence',
    'DISPID_SRCEHypothesis', 'SpeechRecoEvents', 'DISPID_SVGetVoices',
    'DISPID_SVGetAudioInputs', 'DISPID_SRSSupportedLanguages',
    'SpeechCategoryPhoneConverters', 'ISpLexicon', 'SP_VISEME_20',
    'DISPID_SpeechVoiceStatus', 'DISPID_SpeechObjectTokens',
    'DISPID_SOTs_NewEnum', 'DISPID_SLPsItem', 'SGDSActive',
    'SPPS_Unknown', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SGRsFindRule', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SLPLangId', 'DISPID_SpeechMMSysAudio',
    'DISPID_SRRAudioFormat', 'SpeechPartOfSpeech', 'SPBO_PAUSE',
    'SVPNormal', 'DISPID_SASCurrentDevicePosition',
    'SpeechAudioFormatGUIDWave', 'SpeechCategoryVoices',
    'DISPID_SVEStreamEnd', 'SpeechVoiceCategoryTTSRate',
    'SP_VISEME_0', 'SAFTADPCM_11kHzStereo', 'SRADynamic',
    'DISPID_SGRSTWeight', 'SpAudioFormat',
    'SAFTCCITT_uLaw_44kHzStereo', 'ISpeechGrammarRules',
    'DISPID_SOTCDefault', 'DISPID_SPAsItem', 'eLEXTYPE_RESERVED7',
    'eLEXTYPE_PRIVATE8', 'tagSPPROPERTYINFO', 'DISPID_SGRSTRule',
    'SRAONone', 'DISPID_SPIAudioSizeTime',
    'SpeechPropertyResponseSpeed', 'SpStreamFormatConverter',
    'DISPID_SRGRules', 'DISPID_SBSFormat', 'DISPID_SRGetFormat',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SVEWord',
    'ISpeechGrammarRuleStateTransition', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SpeechRecognizer', 'eLEXTYPE_PRIVATE2',
    'eLEXTYPE_PRIVATE19', 'DISPID_SRRSpeakAudio', 'SINoise',
    'DISPID_SPRulesItem', 'SpeechGrammarTagDictation',
    'DISPID_SDKDeleteValue', 'DISPID_SRCAudioInInterferenceStatus',
    'SAFTCCITT_ALaw_22kHzStereo', 'ISpeechLexiconPronunciation',
    'DISPID_SRGState', 'SPAR_Low', 'SWPUnknownWordUnpronounceable',
    'SP_VISEME_6', 'ISpeechMemoryStream',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SRCEPropertyStringChange',
    'SPAS_CLOSED', 'SPSHORTCUTPAIRLIST', 'SAFT32kHz8BitMono',
    'SPPS_Function', 'ISpeechAudioStatus', 'DISPID_SRGDictationLoad',
    'SVP_3', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'Speech_StreamPos_Asap', 'DISPID_SGRs_NewEnum', 'SSTTDictation',
    'SPFM_CREATE_ALWAYS', 'SP_VISEME_8', 'SpeechDisplayAttributes',
    'SAFT11kHz8BitMono', 'SpCompressedLexicon',
    'SpUnCompressedLexicon', 'SPEVENT', 'SPSTREAMFORMATTYPE',
    'SVP_15', 'DISPID_SFSClose', 'DISPID_SpeechXMLRecoResult',
    'SPINTERFERENCE', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'ISpRecoCategory', 'SGSDisabled', 'eLEXTYPE_PRIVATE20',
    'SAFT12kHz16BitStereo', 'DISPID_SASCurrentSeekPosition',
    'SRSInactiveWithPurge', 'ISpEventSink', 'DISPID_SPPName',
    'DISPID_SAEventHandle', 'SPDKL_CurrentUser', 'DISPID_SOTSetId',
    'SAFT8kHz16BitMono', 'SPGS_EXCLUSIVE', 'SAFT16kHz8BitStereo',
    'SpeechRuleAttributes', 'SREStreamEnd', 'SpeechRuleState',
    'SpeechGrammarState', 'DISPID_SGRSTs_NewEnum', 'DISPID_SVEViseme',
    'DISPID_SpeechRecoResult2', 'DISPID_SRSetPropertyString',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SPAPhraseInfo',
    'SpPhraseInfoBuilder', '_SPAUDIOSTATE', 'SPSERIALIZEDPHRASE',
    'DISPID_SPEAudioTimeOffset', 'ISpObjectWithToken',
    'DISPID_SPEPronunciation', 'DISPID_SDKEnumValues',
    'DISPID_SVEBookmark', 'ISpSerializeState',
    'eLEXTYPE_LETTERTOSOUND', 'ISpEventSource', 'DISPID_SRCESoundEnd',
    'DISPID_SPELexicalForm', 'SAFT8kHz8BitStereo',
    'DISPID_SWFEFormatTag', 'SPSHORTCUTPAIR', 'DISPID_SGRsCount',
    'DISPID_SRCEEnginePrivate', 'eLEXTYPE_PRIVATE3',
    'SAFTCCITT_ALaw_44kHzMono', 'SPSHT_EMAIL', 'SpSharedRecoContext',
    'DISPID_SGRSTPropertyValue', 'SpObjectTokenCategory',
    'DISPID_SVAudioOutput', 'DISPID_SPIEngineId', 'SPEI_SOUND_END',
    'SVP_13', 'SPCS_ENABLED', 'SBONone', 'DISPID_SGRAddResource',
    'SGLexicalNoSpecialChars', 'SPEI_SOUND_START', 'SSTTTextBuffer',
    'DISPID_SGRName', 'SVP_16', 'DISPID_SPEAudioStreamOffset',
    'SGRSTTWord', 'SAFTDefault', 'SPVPRI_ALERT',
    'DISPID_SpeechPhraseAlternate', 'SGSEnabled',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SAStatus',
    'DISPID_SpeechWaveFormatEx', 'SpStream', 'SpeechCategoryAudioIn',
    '__MIDL_IWinTypes_0009', 'DISPID_SVAudioOutputStream',
    'DISPID_SDKGetBinaryValue', 'SpLexicon',
    'DISPID_SPEAudioSizeTime', 'DISPID_SPCLangId', 'SDTDisplayText',
    'SPPARTOFSPEECH', 'DISPID_SRCRetainedAudio', 'DISPID_SVSkip',
    'ISpAudio', 'DISPID_SRCEAudioLevel', 'SpeechAudioProperties',
    'SpeechEmulationCompareFlags', 'DISPID_SVEEnginePrivate',
    'ISpeechPhraseProperties', 'SVEEndInputStream',
    'DISPID_SDKSetStringValue', 'SVP_8', 'SFTInput',
    'SpeechVisemeType', 'DISPID_SRCEPhraseStart', 'SPEI_RESERVED1',
    'DISPID_SPEEngineConfidence', 'DISPID_SRCVoicePurgeEvent',
    'SPINTERFERENCE_TOOQUIET', 'SPEI_MAX_TTS',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SITooFast',
    'DISPID_SRRRecoContext', 'SPEI_VOICE_CHANGE',
    'DISPID_SRRPhraseInfo', 'SGPronounciation',
    'DISPID_SpeechGrammarRule', 'SpeechRunState',
    'DISPID_SPRulesCount', 'SPFILEMODE', 'DISPID_SPIElements',
    'SECFEmulateResult', 'DISPID_SOTId', 'ISpRecognizer3',
    'DISPID_SRSAudioStatus', 'DISPID_SVSInputWordPosition',
    'SVSFNLPSpeakPunc', 'DISPID_SABIMinNotification', 'SPWF_INPUT',
    'DISPID_SPIStartTime', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SpeechGrammarRuleState', 'SSFMOpenReadWrite',
    'ISpeechRecoResultDispatch', 'SRERequestUI',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPEI_END_INPUT_STREAM',
    'SDTAlternates', 'SVSFVoiceMask', 'SPINTERFERENCE_NOSIGNAL',
    'SGRSTTTextBuffer', 'SPPS_RESERVED4', 'SVSFIsFilename',
    'DISPID_SGRAttributes', 'DISPID_SLGetGenerationChange',
    'SPSHT_NotOverriden', 'SVF_Emphasis', 'SP_VISEME_4', 'SPWORDTYPE',
    'ISpeechRecoGrammar', 'DISPID_SRCRecognizer',
    'SAFT48kHz16BitMono', 'SPPS_RESERVED2', 'SAFT22kHz8BitStereo',
    'DISPID_SAFGuid', 'SREAllEvents', 'SVEAudioLevel', 'SPSHT_OTHER',
    'SAFT44kHz8BitMono', 'SPTEXTSELECTIONINFO', 'SECFNoSpecialChars',
    'DISPID_SGRsCommit', 'DISPID_SOTCId', 'SAFT8kHz16BitStereo',
    'DISPID_SPPsCount', 'SPRECOGNIZERSTATUS', 'eLEXTYPE_RESERVED6',
    'eLEXTYPE_PRIVATE16', 'SpMMAudioIn', 'DISPID_SGRId',
    'DISPID_SLPType', 'DISPID_SGRSTPropertyId',
    'SVSFPurgeBeforeSpeak', 'DISPID_SRRTLength', 'SPAS_RUN',
    'SpFileStream', 'DISPID_SpeechRecoContextEvents',
    'ISpeechXMLRecoResult', 'STCAll', 'SAFTText',
    'ISpPhoneticAlphabetSelection', 'SPXMLRESULTOPTIONS',
    'DISPID_SRSCurrentStreamPosition', 'SpeechEngineConfidence',
    'SpeechSpecialTransitionType', 'ISpeechPhraseElement',
    'SpeechAudioState', 'SPSSuppressWord',
    'SPEI_PROPERTY_STRING_CHANGE', 'SVP_14', 'SPAS_STOP',
    'SP_VISEME_7', 'SINone', 'SpMMAudioEnum', 'SPDKL_LocalMachine',
    'ISequentialStream', 'DISPID_SOTDisplayUI', 'SDKLDefaultLocation',
    'DISPID_SDKCreateKey', 'SPEI_MAX_SR', 'ISpeechPhraseRule',
    'DISPID_SVSLastResult', 'SpeechLexiconType', 'SRCS_Disabled',
    'SPPS_Verb', 'DISPID_SGRsDynamic', 'SPVPRI_OVER',
    'DISPID_SABIEventBias', 'SpPhoneConverter', 'SP_VISEME_2',
    'tagSPTEXTSELECTIONINFO', 'SPFM_OPEN_READWRITE',
    'DISPID_SPERetainedSizeBytes', 'SPEI_VISEME', 'ISpRecoGrammar',
    'DISPID_SPRuleChildren', 'DISPID_SRCEFalseRecognition',
    'LONG_PTR', 'SPEI_RECOGNITION', 'SPEVENTENUM',
    'DISPID_SLRemovePronunciation', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SRCBookmark', 'ISpRecoResult', 'SP_VISEME_16',
    'DISPID_SpeechLexiconPronunciation', 'SVPOver',
    'SAFTTrueSpeech_8kHz1BitMono', 'SVP_10', 'SECFIgnoreWidth',
    'DISPID_SDKSetLongValue', 'DISPID_SPIReplacements',
    'DISPID_SMSAMMHandle', 'SPGRAMMARWORDTYPE', 'SVP_6',
    'SVEBookmark', 'DISPID_SRRSetTextFeedback', 'SPLEXICONTYPE',
    'DISPID_SRCRetainedAudioFormat', 'SSFMCreate', 'SVP_2',
    'SPCT_DICTATION', 'ISpeechResourceLoader',
    'SPEI_RECO_STATE_CHANGE', 'SpeechCategoryRecognizers',
    'SP_VISEME_21', 'SPPHRASEREPLACEMENT', 'SAFTGSM610_11kHzMono',
    'DISPID_SAVolume', 'DISPID_SVEVoiceChange', 'STCLocalServer',
    'DISPID_SRCSetAdaptationData', 'SAFT24kHz8BitStereo',
    'SPGS_ENABLED', 'SPXRO_SML', 'SpeechGrammarWordType',
    'ISpeechPhraseReplacement', 'DISPID_SAFGetWaveFormatEx',
    'SpPhoneticAlphabetConverter',
    'ISpeechGrammarRuleStateTransitions',
    'DISPID_SRCreateRecoContext', 'SPVPRI_NORMAL', 'SASStop',
    'DISPID_SVSpeakStream', 'SGRSTTWildcard', 'SPSHT_Unknown',
    'SPLO_STATIC', 'ISpeechPhraseAlternate', 'DISPID_SVRate',
    'DISPID_SDKSetBinaryValue', 'DISPID_SLGetPronunciations',
    'DISPID_SOTCSetId', 'SDA_Consume_Leading_Spaces',
    'DISPID_SpeechPhraseAlternates', 'eLEXTYPE_RESERVED8',
    'eLEXTYPE_PRIVATE9', 'SpMemoryStream',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SVF_None',
    'SWTAdded', 'ISpRecoGrammar2', 'ISpeechPhraseAlternates',
    'DISPID_SpeechLexiconWords', 'DISPID_SGRClear',
    'ISpeechPhraseInfoBuilder', 'ISpeechLexicon', 'STCInprocServer',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SPRText',
    'DISPID_SASNonBlockingIO', 'DISPID_SWFEBitsPerSample',
    'DISPID_SAFSetWaveFormatEx', 'SPSEMANTICERRORINFO',
    'SREFalseRecognition', 'DISPID_SVWaitUntilDone',
    'SAFT12kHz8BitMono', 'SAFT22kHz8BitMono', 'DISPID_SVEStreamStart',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'DISPID_SPRuleId',
    'DISPID_SLWType', 'SPFM_NUM_MODES', 'ISpRecoContext',
    'SPEI_RESERVED3', 'DISPID_SpeechAudioFormat', 'DISPID_SVResume',
    'SPSLMA', 'SREPhraseStart', 'SpeechPropertyComplexResponseSpeed',
    'SP_VISEME_19', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SPRuleParent', 'eWORDTYPE_DELETED', 'DISPID_SVPriority',
    'DISPID_SRCEStartStream', 'SpeechTokenKeyFiles', 'SGSExclusive',
    'SECFIgnoreKanaType', 'SRATopLevel', 'SVP_0',
    'DISPID_SRIsUISupported', 'SpeechUserTraining',
    'SPXRO_Alternates_SML', 'SP_VISEME_13',
    'DISPID_SpeechAudioBufferInfo', 'STSF_CommonAppData',
    'DISPID_SRSetPropertyNumber', 'SpeechGrammarTagUnlimitedDictation'
]

_check_version('1.1.14', 1633404129.966498)
